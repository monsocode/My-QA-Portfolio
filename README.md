...
## Where i covered
- SignUp/LoginIn flow
- Major user journey of an e-commerce application
- UI validation
- Test Scripts
...
Test across web and mobile applications, including fintech, logistics, and e-commerce applications.
...
- Performed retesting/sanity/smoke/regression testing after bug fixes
- Validated fixes after deployment
...
- Balance update Validation of Account or Wallet
- Stock dividend payout Validation
